...
# Script Name
ScriptName='Storwize-FlashCopyC-Template.ksh'

# Consistency group Name
ConsistGrp=Consisgrp_Name

# Command prefix (Include username@ip.address)
SshPre='/usr/bin/ssh admin_user@storwize.connect.ip '
