#!/usr/bin/ksh93
####################################################################################
# SpectrumScale-Suspend-bak1.ksh - SpectrumScale Suspend (Snapshot) Script
...
PL="------------------------------------------------------------"
print
print "Start Filesystem Suspend."
print $PL
print "Start Time \t\t= "`date +%Y-%m-%d-%H:%M:%S`
print "Script Name \t\t= $ScriptName"
print $PL
# Start Suspend.
mmfsctl p012bandvol suspend-write
mmfsctl p012redovol suspend-write
print
